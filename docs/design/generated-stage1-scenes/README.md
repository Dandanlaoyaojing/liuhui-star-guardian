# Stage 1 Scene Concepts

Generated on 2026-04-22 using Codex built-in image generation.
...
All images in this batch were generated against the same shared art-direction rules:

- Arrog-inspired unified hand-drawn language
- line-first illustration with visible hand-drawn ink contours
- restrained low-saturation watercolor tinting
- functional minimalist machinery
- large breathing negative space
...
- `M02-lost-navigation-compass-v1.png`
- `M03-frozen-river-of-stars-v1.png`
- `M04-entangled-interstellar-signals-v1.png`
- `M05-broken-balance-starplate-v1.png`
- `M06-dormant-causal-chain-v1.png`
- `M07-shattered-star-kaleidoscope-v1.png`
- `M08-reversed-star-waterfall-v1.png`
- `M09-folded-star-envelope-v1.png`
- `M10-sleeping-star-garden-v1.png`
